      ...
      {session ? (
        <div className="h-screen w-full flex items-center justify-center flex-col gap-5">
          ...
          {session.user?.image && <Image 
            ...
            className="w-[100px] height-[100px] object-contain" 
            width={100}
            height={100}
          />}
          
          <h1 className="text-4xl text-gray-700">Bienvenue <b>{session.user?.name}</b></h1>
          <p><b>Votre email:</b> {session.user?.email}</p>
